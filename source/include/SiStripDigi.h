...
#define STRIPRPHI 0      // Const denoting strips in R-Phi
#define STRIPZ    1      // Const denoting strips in Z
...
//!Method digitizing given SimTrackerDigiHit - takes into account all relevant physical
//!processes: landau fluctuations, drift, diffusion, Lorentz shift in magnetic
//!field (input parameter: a pointer to digitized hit, output parameter: a sensor
//!map of strips with total integrated charge and time when particle crossed the
//!sensor)
...
//!Method transforming given SimTrackerHit into local ref. system of each sensor, resp.
//!wafer, where the center is positioned such as x, y and z coordinates are
//!always positive and x is in direction of thickness.
...
//!Get method - returns total ELECTRON drift time (parameters: electron position
...
//!Get method - returns actual ELECTRON inverse velocity, calculated as follows:
//!
...
// Root output
   ...
   TH1F  * _rootELossDigi;         //!< Histogram of energy losses fluctuations generated by SiPxlDigi
   TH1F  * _rootELossG4;           //!< Histogram of energy losses fluctuations generated by Geant4

   double _rootDepEG4;             //!< Deposited energy generated by Geant4
   double _rootDepEDigi;           //!< Deposited energy generated by internal fluctuator
#endif
